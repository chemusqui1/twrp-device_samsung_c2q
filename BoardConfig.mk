...
BOARD_PREBUILT_DTBOIMAGE := device/samsung/c2q/prebuilt/recovery_dtbo
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPTC04B002"
...
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_SIZE := 10817105920 # BOARD_SUPER_PARTITION_SIZE - 4MB
...
TW_DEVICE_VERSION := ReBorn_c2q-Internal0.2
